...
interface MapRepository {
    ...
    suspend fun getAddedPlaceListByLocation(locationId: Int): Result<Pair<Int, List<PlaceReviewEntity>>>
    suspend fun getAddedPlaceList(categoryId: Int): Result<Pair<Int, List<PlaceReviewEntity>>>
