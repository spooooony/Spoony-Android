...
fun PlaceDetailScreen() {
    ...
    val textTile = "인생 이자카야. 고등어 초밥 안주가 그냥 미쳤어요."
    val textContent = "이자카야인데 친구랑 가서 안주만 5개 넘게 시킴.. 명성이 자자한 고등어봉 초밥은 꼭 시키세요! 입에 넣자마자 사르르 녹아 없어짐. 그리고 밤 후식 진짜 맛도리니까 밤 디저트 좋아하는 사람이면 꼭 먹어보기! "
    var isSpoonEat by remember { mutableStateOf(false) }
    val profileUrl = "https://gratisography.com/wp-content/uploads/2024/10/gratisography-cool-cat-800x525.jpg"
    val profileName = "안세홍"
    val profileLocation = "성북구 수저"
    val dropdownMenuList = immutableListOf("신고하기")
    val imageList = immutableListOf(
    ...
    val dateString = "2025년 1월 2일"
    val locationAddress = "서울 마포구 연희로11가길 39"
    val locationName = "어키"
    val locationPinCount = 99
    val mySpoonCount = 99
    Box(
    ...
    Row(
        ...
        if (isSpoonEat) {
            ...
            Column(
                ...
                Icon(
                    painter = painterResource(id = R.drawable.ic_add_map_gray400_24),
                    modifier = Modifier
                        .size(32.dp),
            ...
            SpoonyButton(
                ...
                icon = {
                    Icon(
                        painter = painterResource(R.drawable.ic_button_spoon_32),
