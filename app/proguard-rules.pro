...
-keepclassmembers @kotlinx.serialization.Serializable class com.spoony.spoony.** {
...
# lookup for plugin generated serializable classes
-if @kotlinx.serialization.Serializable class com.spoony.spoony.**
-keepclassmembers class com.spoony.spoony.<1>$Companion {
    kotlinx.serialization.KSerializer serializer(...);
}
...
-keep class com.spoony.spoony.SerializableClassWithNamedCompanion$$serializer {
    *** INSTANCE;
}

-keep class com.spoony.spoony.** {
